...
public class BasicData {
    ...
    public static class MessageBasic implements Serializable {
        ...
        public String get_realdataid() {
            return this._realdataid;
        }
        ...
        public void set_realdataid(String param1String) {
            this._realdataid = param1String;
        }
