...
public class MessageOtherListAdapter extends AdapterBase<MessageBean.MessageBeanContent> {
    private Context context;

    public MessageOtherListAdapter(Context paramContext) {
        super(paramContext);
    ...
    protected View getExView(int paramInt, View paramView, ViewGroup paramViewGroup) {
        ...
        if (paramView == null) {
            ...
            paramView = this.mInflater.inflate(R.layout.item_messageotherlist, null);
